...
export default async function addAgentRoutes(fastify, supabaseClient) {
    fastify.post('/add-agent', async (request, reply) => {
        try {
            ...
            const { agent_name, email, temp_password, business_type, whatsapp_number, webhook_url, api_key, business_account_id, phone_number_id, createdBy } = body;
