  ...
  return (
    <div style={{ display: 'flex', height: '100vh', background: '#f8faf8', overflow: 'hidden' }}>
      ...
      <motion.aside
        ...
        style={{ width: 240, background: '#0c1a0e', display: 'flex', flexDirection: 'column', flexShrink: 0, overflow: 'hidden' }}
      >
        {/* Logo */}
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        {/* Header */}
        <header style={{ background: '#fff', borderBottom: '1px solid #ebebeb', padding: '14px 28px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
