  ...
  return (
    <Portal>
      ...
      >
        ...
        >
          {/* Modal Header */}
          <div className="px-4 py-3.5 sm:px-6 sm:py-4 border-b border-[#EAEAEA] flex items-center justify-between shrink-0">
            <div className="flex items-center gap-3 min-w-0 mr-2">
              ...
              <div className="min-w-0">
                <h3 className="text-sm sm:text-base font-extrabold text-[#16281D] tracking-tight truncate">
          ...
          <div className="p-4 sm:p-6 overflow-y-auto flex flex-col gap-4">
            ...
            <div className="p-3.5 sm:p-4 bg-[#F4F7F4] border border-[#EAEAEA] rounded-2xl flex flex-col gap-2.5">
              ...
              <div className="pt-2 border-t border-[#EAEAEA]/80 flex items-center justify-between text-xs text-[#71717A] gap-2">
                ...
                {payingInvoice.generated_at && (
                  <span className="shrink-0 text-[10.5px] font-mono text-[#71717A]">
                    {new Date(payingInvoice.generated_at).toLocaleDateString("en-US", {
                      month: "short",
                      day: "numeric",
                      year: "numeric",
                    })}
          ...
          {/* Modal Footer */}
          <div className="p-3.5 sm:px-6 sm:py-4 border-t border-[#EAEAEA] bg-white flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5 sm:gap-3 shrink-0">
