            ...
            <div className="flex items-center space-x-3">
              <div className="p-2 bg-blue-100 rounded-2xl">
                <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 01-2-2m0 13l6-6m-6 6V5a2 2 0 012-2h2a2 2 0 012 2v8a2 2 0 001 1.732V19a2 2 0 01-2 2h-1v-6a1 1 0 00-1-1H9a1 1 0 00-1 1v6H7a2 2 0 01-2-2v-4a2 2 0 011.732-1.732M9 5a2 2 0 002 2h2a2 2 0 002-2m0 4v-6a1 1 0 00-1-1H9a1 1 0 00-1 1v6H7" />
                </svg>
              </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 lg:p-6">
            ...
            <div className="mb-6">
                  ...
                  <div key={index} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-xl">
                    <div className="flex-1">
                      <input
                        ...
                        className={`w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${businessType === 'product' ? 'bg-gray-100 cursor-not-allowed' : ''}`}
                    ...
                    <div className="w-24">
                      <input
                        ...
                        step="0.01"
                        placeholder="Price"
                        className={`w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-right ${businessType === 'product' ? 'bg-gray-100 cursor-not-allowed' : ''}`}
                        readOnly={businessType === 'product'}
                      />
                    </div>
              ...
              {businessType === 'service' ? (
                ...
                <div className="space-y-3">
                  <label className="block text-sm font-medium text-gray-700 mb-2">Add Products from Inventory</label>
                  <input
                    type="text"
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-xl">
              <div className="flex justify-between items-center">
                ...
                <span className="text-2xl font-bold text-blue-600">LKR {totalAmount.toFixed(2)}</span>
              </div>
            </div>
          </div>
