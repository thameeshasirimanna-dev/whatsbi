          ...
          <div className="px-6 py-5 border-b border-[#EAEAEA] flex items-center justify-between shrink-0 bg-white">
            <div className="flex items-center gap-3">
              {service.image_urls && service.image_urls.length > 0 ? (
                ...
                <div className="w-10 h-10 rounded-xl bg-[#16281D]/5 flex items-center justify-center text-[#16281D] shrink-0">
                  <Briefcase size={18} />
                </div>
              )}
              <div>
                <h3 className="font-sans text-base font-bold text-[#16281D]">{service.service_name}</h3>
